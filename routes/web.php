...
Route::resource('gallery_media','GalleryMediaController',['except' => ['destroy']]);
Route::get('gallery_media/{id}/destroy/{id1}','GalleryMediaController@destroy');
...
Route::get('/client/getAllProfiles', array('uses' => 'ProfileController@getAllVisibleProfiles'));
